...
class Settings(BaseSettings):
    ...
    # Blockchain and transaction constants
    ...
    MEMPOOL_THRESHOLD: int = 1000  # Mempool size for fee rate increase
    BLOCK_FULLNESS_THRESHOLD: float = 0.8  # 80% of BLOCK_SIZE_LIMIT
    FEE_RATE_UPDATE_INTERVAL: int = 60  # Seconds to update fee rate
...
# Expose constants directly for import
